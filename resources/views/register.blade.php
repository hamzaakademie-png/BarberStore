...
<head>
    ...
    <title>Kayıt Ol - BarberStore</title>
    ...
    <style>
        ...
        .auth-header {
            ...
            text-align: center;
            border-bottom: 2px solid #c8962b;
        }
        .auth-header .tagline-top {
            font-size: 13px;
            letter-spacing: 3px;
            color: #c8962b;
            font-weight: 500;
...
<body>
    ...
    <div class="auth-card">
        ...
        <div class="auth-body">
            <div class="auth-title">Aramıza katıl</div>
            <div class="auth-subtitle">Hesap oluştur, ayrıcalıkları keşfet</div>
            ...
            <form method="POST" action="/register">
                ...
                <button type="submit" class="btn-gold">KAYDOL</button>
            </form>
